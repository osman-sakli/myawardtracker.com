# ---------------------------------------------------------------------------
# HTTP API (cheaper than REST API). Authorized routes use a Cognito JWT
# authorizer; the Stripe webhook is public but signature-verified in code.
# ---------------------------------------------------------------------------
...
# ---- Custom domain: api.myawardtracker.com --------------------------------
